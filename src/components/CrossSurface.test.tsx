...
const event = {
  ...
  target: "seller-agent",
  timestamp: "2026-07-12T05:00:00+08:00",
  sequence: 1,
  payload: {
    productName: "Newborn CalmSleep Kit",
    amountUsd: 164,
    humanClicks: 0,
  },
};

describe("买家端与商家端共享交易投影", () => {
  it("卖家战情加载买家侧产生的真实 transaction", async () => {
      ...
      vi.fn(async () => ({
        ...
        json: async () => ({
          transactions: [
            {
              id: "tx-shared",
              kind: "active-sales-demo",
              status: "completed",
              statusLabel: "已完成",
              buyerName: "Mia Park · New Parent",
              product: "Newborn CalmSleep Kit",
              category: "母婴床品",
              ...
              score: 94,
              updatedAt: "2026-07-12T05:00:00+08:00",
              events: [event],
              chainValid: true,
            },
          ],
  ...
  it("买家 Inbox 可以打开同一 transaction 的事件链", async () => {
      ...
      messages: [
        {
          ...
          title: "授权主动提案已自动成交",
          receivedAt: "2026-07-12T05:00:00+08:00",
          category: "母婴床品",
          offer: "$164",
          evidence: ["Hash Chain verified"],
          verdict: "valuable",
          verdictLabel: "自动成交",
          valueScore: 94,
          agentEvaluation: "提案满足全部授权条件。",
    ...
    expect(await screen.findByText("买家与卖家共享事件链")).toBeInTheDocument();
