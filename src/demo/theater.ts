...
const REJECT_BRANDS = [
  '特惠数码', '极速3C', '环球电子', '闪购优选', '数码岛', '捷创科技',
  '惠买网', '星链电子', '速达3C', '鼎盛数码', '联合优选', '云购商城',
  '极客仓', '众诚电子', '捷丰数码', '优达优选', '恒信3C', '速购网',
  '明达电子', '汇通数码', '智选优品', '速联科技', '鑫源电子', '捷通商城',
  '优诚数码', '速卖通选', '联采优品', '锐驰电子',
]
...
export const ARENA_ROUNDS: DealRound[] = [
  ...
  },
  {
    ...
    cardType: 'counter',
    title: '反制：溢价合理',
    detail: '极物售后响应分仅 80，我方 96；186 笔履约零争议。差价买的是确定性。',
    price: 8799,
    chip: '售后 96 vs 80',
  },
  {
    ...
    cardType: 'counter',
    title: '加筹码换让价',
    detail: '认可你的时效与售后。我方即时确认 + 全款托管，换 ¥8,499 + 3 年联保。',
    price: 8599,
    chip: '托管支付 · 零违约风险',
  },
  {
  ...
  },
  {
    ...
    cardType: 'close',
    title: '成交',
    detail: '¥8,499 成交，较开价省 ¥300 且延保多 1 年。全部硬约束满足，请求你确认。',
    price: 8499,
    chip: '省 ¥300 + 延保 1 年',
  },
]
