...
export const CREDIT_DIMS: Array<{ key: keyof CreditVector; label: string; short: string }> = [
...
export type TxStatus = 'signal' | 'bidding' | 'settled' | 'fulfilling' | 'attested'
